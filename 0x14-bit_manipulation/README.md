...
6. Endianness
#advanced
OBOBOBWrite a function that checks the endianness.

OBOBOBPrototype: int get_endianness(void);
Returns: 0 if big endian, 1 if little endian
OBOBOBjulien@ubuntu:~/0x14. Binary$ cat 100-main.c
OBOBOB#include <stdio.h>
...
OAOAOAArchitecture:          x86_64
CPU op-mode(s):        32-bit, 64-bit
OAOAOAByte Order:            Little Endian
OAOAOACPU(s):                1
OAOAOAOn-line CPU(s) list:   0
Thread(s) per core:    1
OAOAOACore(s) per socket:    1
OAOAOASocket(s):             1
NUMA node(s):          1
OAOAOAVendor ID:             GenuineIntel
julien@ubuntu:~/0x14. Binary$
Repo:
